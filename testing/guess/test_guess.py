...
"""
using the @patch(builtins.input, side_effect=[])
alllows you to test specific resposnes for a randomized function
"""
...
"""
# found a bug in testing for just searching for a single correc instance
# fixed and the string printed out just fine
